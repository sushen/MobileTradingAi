...
class PhaseAdapter(
    ...
    private val allPhases: List<Phase>,
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        // Find missing prerequisite across all phases
        val sortedAllPhases = allPhases.sortedBy { it.order }
        val currentPhaseIndex = sortedAllPhases.indexOfFirst { it.phaseId == phase.phaseId }
        val truePreviousPhase = if (currentPhaseIndex > 0) sortedAllPhases[currentPhaseIndex - 1] else null
        val isMissingPrerequisite = truePreviousPhase != null && !userUnlockedPhases.contains(truePreviousPhase.phaseId)
        ...
        holder.binding.apply {
            ...
            when {
                ...
                isMissingPrerequisite -> {
                    phaseState = "LOCKED"
                    statusMessage = "Complete ${truePreviousPhase?.title} before requesting this phase."
